...
def _process_single_fold(fold_data, le, clf_name, n_estimators, max_depth,
    ...
    gc.collect()
    return _yt, _yp, acc, subject_id, None, None
# ============================================================================
...
def _evaluate_loso_parallel(features, labels, subject_groups, le, clf_name,
    ...
    for yt, yp, acc, subj, model, Xt in results:
    ...
    return y_true_all, y_pred_all, accs, per_subject_acc, trained_models, X_tests
...
def evaluate_model(features, labels, subject_groups,
    ...
    if strategy == 'loso':
        (y_true_all, y_pred_all, accs, per_subject_acc,
    ...
    if not return_models:
        return mean_acc, std_acc, cm, acc_values, [], []
    return mean_acc, std_acc, cm, acc_values, trained_models, X_tests
